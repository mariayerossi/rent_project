                    ...
                    @if (!$data->isEmpty())
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td><button class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModal{{$item->id_mobil}}" data-whatever="@mdo">Edit</button><a href="/admin/mobil/atur/{{$item->id_mobil}}" class="btn btn-outline-primary">Atur</a></td>
                            </tr>
